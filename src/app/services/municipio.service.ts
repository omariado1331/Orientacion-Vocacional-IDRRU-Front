...
getMunicipiosPorProvincia(idProvincia: number): string[] {
  ...
  municipiosN: MunicipioN[] = [
    ...
    new MunicipioN(11, 'GENERAL JUAN JOSÉ PEREZ (CHARAZANI)', 'BAUTISTA SAAVEDRA'),
    new MunicipioN(12, 'ESCOMA', 'CAMACHO'),
    new MunicipioN(13, 'HUMANATA', 'CAMACHO'),
    new MunicipioN(14, 'MOCOMOCO', 'CAMACHO'),
    ...
    new MunicipioN(29, 'TIHUANACO', 'INGAVI'),
    ...
    new MunicipioN(35, 'LICOMA PAMPA', 'INQUISIVI'),
    ...
    new MunicipioN(46, 'TIPUANI', 'LARECAJA'),
    ...
    new MunicipioN(54, 'PUERTO PEREZ', 'LOS ANDES'),
    ...
    new MunicipioN(63, 'EL ALTO', 'MURILLO'),
    new MunicipioN(64, 'LA PAZ', 'MURILLO'),
    ...
    new MunicipioN(76, 'CAQUIVIRI', 'PACAJES'),
    ...
    new MunicipioN(83, 'CHULUMANI', 'SUDYUNGAS'),
    new MunicipioN(84, 'IRUPANA', 'SUDYUNGAS'),
    new MunicipioN(85, 'LA ASUNTA', 'SUDYUNGAS'),
    new MunicipioN(86, 'PALOS BLANCOS', 'SUDYUNGAS'),
    new MunicipioN(87, 'YANACACHI', 'SUDYUNGAS')
  ]
}
