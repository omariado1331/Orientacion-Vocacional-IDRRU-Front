...
import {ConfiguracionAdminComponent} from './pages/configuracion-admin/configuracion-admin.component';
...
export const routes: Routes = [
    ...
    {path: 'admin/configuracion', component: ConfiguracionAdminComponent},
